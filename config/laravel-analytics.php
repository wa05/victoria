...
return
    ...
    [
         ...
         */
        'clientId' => 'bfe4248db1b65cf9636115eda7d752cffb25ba94',
         ...
         */
        'serviceEmail' => 'vicbir@victoriabirchner.iam.gserviceaccount.com',

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('app/laravel-analytics/victoriabirchner-bfe4248db1b6.p12'),
